...
from . import c8k19_settings as settings
...
def run_experiment():
    ...
    while True:
        if os.path.exists(experiment_path):
            ...
            settings_path = os.path.join(mmi_dir_path, 'c8k19_settings.py')
            copyfile(settings_path, os.path.join(experiment_path, 'c8k19_settings.py'))
            break     
